(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["VideoH5Resize"] = factory();
	else
		root["VideoH5Resize"] = factory();
})(this, function() {
...
var Toolbar = function (_BaseModule) {
  ...
  function Toolbar(resizer) {
    ...
    var _this = _possibleConstructorReturn(this, (Toolbar.__proto__ || Object.getPrototypeOf(Toolbar)).call(this, resizer));
...
var knownModules = {
	DisplaySize: __WEBPACK_IMPORTED_MODULE_2__modules_DisplaySize__["a" /* DisplaySize */],
	Toolbar: __WEBPACK_IMPORTED_MODULE_3__modules_Toolbar__["a" /* Toolbar */],
...
var VideoH5Resize = function () {
	function VideoH5Resize(quill) {
		var _this = this;

		var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

		_classCallCheck(this, VideoH5Resize);
	...
	_createClass(VideoH5Resize, [{
		...
		value: function handleClick(evt) {
			if (evt.target === this.quill.root) {
				var videosH5 = this.quill.root.querySelectorAll('video');
				console.log(videosH5);
				var videos = this.quill.root.querySelectorAll('iframe');
	...
	return VideoH5Resize;
}();

/* harmony default export */ __webpack_exports__["default"] = (VideoH5Resize);
